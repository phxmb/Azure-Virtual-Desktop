...
$galleryImageDefinitionName = Get-AzResource -ResourceType Microsoft.Compute/galleries/images | Select-Object -Property name | Out-GridView -OutputMode Single -Title 'Select the Image Definition'
