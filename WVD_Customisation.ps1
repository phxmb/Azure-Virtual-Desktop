...
Invoke-WebRequest -Uri 'https://phxmbwvd.blob.core.windows.net/mbautomation/Language.zip' -OutFile 'c:\temp\language.zip'
...
##Download Inbox Apps ISO##
#Invoke-WebRequest -Uri 'https://software-download.microsoft.com/download/pr/19041.508.200905-1327.vb_release_svc_prod1_amd64fre_InboxApps.iso' -OutFile 'c:\temp\Inbox.iso'
...
#Mount Inbox Apps ISO#
# ISO image - replace with path to ISO to be mounted
#$isoImg = "C:\temp\Inbox.iso"
# Drive letter - use desired drive letter
#$driveLetter = "Z:"
...
#Start-Sleep -Seconds 10
# Copy files to C:\WVD
#Copy-Item "Z:\amd64fre\*" "c:\wvd\Language"
...
Invoke-WebRequest -Uri 'https://query.prod.cms.rt.microsoft.com/cms/api/am/binary/RE4AQBt' -OutFile 'c:\temp\MsRdcWebRTSvc.msi'
...
((Get-Content -Path C:\WVD\Virtual-Desktop-Optimization-Tool-master\2009\ConfigurationFiles\AppxPackages.json -Raw) -replace 'Microsoft.Microsoft.ScreenSketch', 'Microsoft.ScreenSketch_DonNotRemove') | Set-Content -Path C:\WVD\Virtual-Desktop-Optimization-Tool-master\2009\ConfigurationFiles\AppxPackages.json
...
.\Win10_VirtualDesktop_Optimize.ps1 -WindowsVersion 2009 -Verbose *> "C:\WVD\DONOTDELETE.log" -Restart 
'}

#method for adding scheduled task for WVD Optimisation
$task = Get-ScheduledTask -TaskName 'WVD Customisation' -ErrorAction Continue
if(!($task.TaskName -eq 'WVD Customisation')) {
